...
(function ($) {
	...
	var DTimePicker = function(elem, options){
		...
		this.ampm = $('<input class="tp_am_pm" type="text" maxlength="2" style="width:25px;">');
                */
		this.hour = $('<input class="tp_hr" type="text" style="width:23px;" maxlength="2">');
		this.min = $('<input class="tp_min" type="text" style="width:23px;" maxlength="2">');
		this.ampm = $('<input class="tp_am_pm" type="text" maxlength="2" style="width:30px;">');
