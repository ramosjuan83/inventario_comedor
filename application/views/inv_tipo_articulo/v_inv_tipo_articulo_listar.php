    ...
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    <i class="color_7 fas fa-list fa-2x"></i>
                    <span class="color_7">Tipo de Artículo</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <div class="col-md-6 float-left text-right container-fluid mt-2">
                ...
                if( strlen($this->session->userdata('inv_tipo_articulo_mensaje_tipo')) > 0  ){ ?>
                        <div class="alert <?php echo $this->session->userdata('inv_tipo_articulo_mensaje_tipo'); ?> text-center"><?php
                            echo $this->session->userdata('inv_tipo_articulo_mensaje_contenido'); ?>
                        </div><?php
                        $s_mensaje = array(
                                'inv_tipo_articulo_mensaje_tipo'         => '',
                                'inv_tipo_articulo_mensaje_contenido'    => ''
                        );
                        $this->session->set_userdata($s_mensaje);
                } ?>
            </div>
            <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Inv_tipo_articulo/agregar'); ?>" class="btn btn-primary">
                ...
                <table class="table table-hover bg-white" style="box-shadow: 1px 5px 5px 1px #d9d9d9">
                    <thead class="bg_color_1 text-white">
                        <tr class="text-center">
                            ...
                            <th scope="col" class="text-left">OBSERVACION</th>
                            ...
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    ...
                                    <?php if ($dat->id_status !=2) { ?>
                                        <a class="text_azul mr-2" href="<?=site_url('Inv_tipo_articulo/editar/'.$dat->id)?>">
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Inv_tipo_articulo/eliminar/'.$dat->id); ?>">
