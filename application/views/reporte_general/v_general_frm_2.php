                ...
                <!--<div class="row">-->
                    <div class="card-header bg_color_2">
                        <h4>
                            ...
                            switch ($oper){
                                case 'reporte_form': ?>
                                        <span class="text-white">Reporte General</span><?php
                                    ...
                                    function ver_reporte(formato){
                                        if(valida() == true){
                                            ...
                                            if(formato == 'pdf'){
                                                ...
                                                window.open("<?php echo ''.base_url('').''?>index.php/Inv_inventario/llama_reporte_general_form/"+id_articulo+"/"+id_almacen+"/"+$b_fecha_desde+"/"+$b_fecha_hasta+"/"+"/pdf");
                                            }
                                            if(formato == 'excel'){
                                                window.open("<?php echo ''.base_url('').''?>index.php/Inv_inventario/llama_reporte_general_form/"+id_articulo+"/"+id_almacen+"/"+$b_fecha_desde+"/"+$b_fecha_hasta+"/"+"/excel");
