    ...
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    <i class="color_7 fas fa-list-ul fa-2x"></i>
                    <span class="color_7">Artículo</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <div class="col-md-6 float-left text-right container-fluid mt-2">
                ...
                if( strlen($this->session->userdata('inv_articulo_mensaje_tipo')) > 0  ){ ?>
                        <div class="alert <?php echo $this->session->userdata('inv_articulo_mensaje_tipo'); ?> text-center"><?php
                            echo $this->session->userdata('inv_articulo_mensaje_contenido'); ?>
                        </div><?php
                        $s_mensaje = array(
                                'inv_articulo_mensaje_tipo'         => '',
                                'inv_articulo_mensaje_contenido'    => ''
                        );
                        $this->session->set_userdata($s_mensaje);
                } ?>
            </div>
            <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Inv_articulo/agregar'); ?>" class="btn btn-primary">
                ...
                <table class="table table-hover bg-white" style="box-shadow: 1px 5px 5px 1px #d9d9d9">
                    <thead class="bg_color_1 text-white">
                        <tr class="text-center">
                            ...
                            <th scope="col" class="text-left">Tipo de Artículo</th>
                    ...
                    if($dat_list != false){
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    ...
                                    <td class="text-left"><?=$dat->codigo?></td>
                                    <td class="text-left"><?=$dat->nombre?></td>
                                    <td class="text-center"><?=$dat->nombre_tipo_articulo ?></td>
                                    <td class="text-center"><?=$dat->nombre_medida?></td>
                                    <!-- <td class="text-center"><?=$dat->nombre_almacen?></td> -->
                                    <td class="text-center"><?=$dat->observacion?></td>
                                    <td class="text-center"><img src="<?php echo base_url()."images/articulo/".$dat->imagen_articulo=$dat->imagen_articulo!=''?$dat->imagen_articulo:'sin_imagen.png'; ?>"  width="150" height="150" border="2px"> </td>
                                    <td>
                                        
                                    <?php if ($dat->id_status !=2) { ?>
                                        <a class="text_azul mr-2" href="<?=site_url('Inv_articulo/editar/'.$dat->id)?>">
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Inv_articulo/eliminar/'.$dat->id); ?>">
