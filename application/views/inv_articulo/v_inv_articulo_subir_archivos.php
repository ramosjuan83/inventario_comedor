            ...
            <div class="card card-login mx-auto bg-white border-0 card-shadow" style="margin-top: 10px; max-width: 50rem">
                <!--<div class="row">-->
                    ...
                    <div class="col-md-12 float-left text-right container-fluid mt-2"><?php
                        if( strlen($this->session->userdata('personal_mensaje_tipo')) > 0  ){ ?>
                                <div class="alert <?php echo $this->session->userdata('personal_mensaje_tipo'); ?> text-center"><?php
                                    echo $this->session->userdata('personal_mensaje_contenido'); ?>
                                </div><?php
                                $s_mensaje = array(
                                        'personal_mensaje_tipo'         => '',
                                        'personal_mensaje_contenido'    => ''
                                );
...
////mostrarArchivos();
                        ...
                        <form action="<?php echo ''.base_url('').''?>index.php/Personal_ivic/<?php echo $oper_g; ?>" name="form_principal" id="form_principal" method="post" enctype="multipart/form-data" target="_parent">
                    ...
                    //if($menu_origen == 'editar_como_administrador'){ ?>
                        <a href="<?=site_url('Inv_articulo/editar/'.$id)?>" id="btn_float" class="button button-circle button-flat-primary bg_color_3">
