                ...
                <!--<div class="row">-->
                    <div class="card-header bg_color_2">
                        <h4>
                            ...
                            <i class="text-white fas fa-arrow-right fa-2x"></i>
                            <?php
                            switch ($oper){
                                case 'agregar': ?>
                                        <span class="text-white">Agregar Despacho</span><?php
                                        $oper_g = "agregar_guardar";
                                break;
                                case 'editar': ?>
                                        <span class="text-white">Editar Despacho</span><?php
...
*/
                        ...
                        function disponibilidad2(oper){ 
                            ...
                            function valida_nombre(oper){
                                ...
                                // if(oper == "agregar"){
                                //     $.post(baseurl+"index.php/Inv_despacho/get_inv_despacho_buscar_6",
                                //     {
                                //                 nombre: nombre
                                //     },
                                //     function(data){ //alert(data);
                                ...
                                //     $.post(baseurl+"index.php/Inv_despacho/get_inv_despacho_buscar_5",
                                //     {
                                //                 nombre: nombre
                                //             ,   id: id
                                //     },
                            ...
                            function valida_saldo(oper){
                             ...
                             function mostrar_unidad(valor){
                                ...
                                let arr=text.split('-');
                                document.getElementById("disponibilidadUnidad").innerHTML= `Disponibilidad (${arr[1]})`;
                        ...
                        ?>
                        <?php echo form_open('Inv_despacho/'.$oper_g, $atributos2);
                        ...
                        <div class="row">
                            <div class="col-md-6 float-left text-right container-fluid mt-2">
                                ...
                                if( strlen($this->session->userdata('inv_despacho_mensaje_tipo')) > 0  ){ ?>
                                        <div class="alert <?php echo $this->session->userdata('inv_despacho_mensaje_tipo'); ?> text-center"><?php
                                            echo $this->session->userdata('inv_despacho_mensaje_contenido'); ?>
                                        </div><?php
                                        $s_mensaje = array(
                                                'inv_despacho_mensaje_tipo'         => '',
                                                'inv_despacho_mensaje_contenido'    => ''
                                        );
                        ...
                        <div class="row">
                            <div class="col-md-6 float-left">
                                ...
                                <br />
                                <select class="form-control bg-sigalsx4-purpple_dark text-white selectpicker" id="id_articulo" name="id_articulo" onchange="mostrar_unidad(this.text)" data-show-subtext="true" data-live-search="true"><?php
                            ...
                            <div class="col-md-6">
                                            ...
                                            <input class="form-control" type="text" id="fecha" name="fecha" value='<?php if( isset($fila_registro->fecha_egreso) ){ echo $fila_registro->fecha_egreso; }else{ echo date("d/m/Y"); } ?>' size="10" >
                                            <span id="error_fecha_de_ingreso" style="display: none" class="text-danger error-camp">
                                                <i class="fa fa-exclamation-circle fa-2x"></i> 
                                                Seleccionar Fecha
                                            </span>
                                            <!-- <input type="hidden" name="fecha" id="fecha" value='<?php if( isset($fila_registro->fecha_egreso) ){ echo $fila_registro->fecha_egreso; }else{ echo date('d-m-Y'); } ?>'> -->
                            </div>
                            <div class="col-md-6 float-left">
                            ...
                            <div class="col-md-6 container-fluid">
                                        <label id='disponibilidadUnidad'>Disponibilidad <span style="color:#F00;"></span></label>
                                        <br />
                                        <?php
                    ...
                    <a href="<?php echo site_url('Inv_despacho/listar/cargo_ultima_pagina'); ?>" id="btn_float" class="button button-circle button-flat-primary bg_color_3">
