                ...
                <!--<div class="row">-->
                    <div class="card-header bg_color_2">
                        <h4>
                            ...
                            <i class="text-white far fa-address-card fa-2x"></i>
                            <?php
                            //echo "nombre *".$nombre."*";
                            switch ($oper){
                                case 'editar_contrasena_para_reiniciar_password': ?>
                                        <span class="text-white">Usuario Registro y Login</span><?php
                                        $oper_g = "editar_guardar_para_reiniciar_password";
                                break;
                            } ?>
                    ...
                    <div class="card-body bg-white">
                        ...
                        <input type="hidden" id="olvido_pass_identificador" name="olvido_pass_identificador" value="<?php if( isset($olvido_pass_identificador) ){ echo $olvido_pass_identificador; } ?>" >
                        ...
                        <div class="row mt-0">
                            ...
                            <div class="col-md-6 float-left  mt-3">
                                <div class="alert alert-primary" role="alert">
                                    Reiniciar contraseña de su cuenta
                                </div>                                    
                            </div>
                        </div>                            
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 float-left">
                                <input class="btn btn-outline-sigalsx4-purpple" type="submit" name="Guardar" value="Reiniciar Contraseña">
                            </div>
                        </div>
                    ...
                    <a href="<?=site_url('')?>" id="btn_float" class="button button-circle button-flat-primary bg-sigalsx4-purpple">
