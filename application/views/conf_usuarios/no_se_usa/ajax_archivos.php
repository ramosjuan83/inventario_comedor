<script type="text/javascript">
        ...
        function mostrarArchivos(){
            ...
            $.post(baseurl+"index.php/Conf_usuarios/get_conf_usuarios_buscar_2",
            {
                id_usuario: id_usuario
            },
            function(data){ //alert(data);
                var matriz_conf_usuarios = JSON.parse(data);
                imagen_nombre = matriz_conf_usuarios[0]['imagen_nombre']
                if(imagen_nombre == null){
                    $("#archivos_subidos").html("");
                }else{
                    $("#archivos_subidos").html("");
                    $ruta = '<?php echo base_url("images/conf_usuario/"); ?>'+imagen_nombre;
                    ...
                    $("#archivos_subidos").append("\
                        <li class='list-group-item'>\
                            <a class='text-danger mr-2' href='#' data-toggle='modal' data-target='#exampleModal_eliminar_"+id_usuario+"'>\
                        ...
                        <div class='modal fade' id='exampleModal_eliminar_"+id_usuario+"' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>\
                          <div class='modal-dialog' role='document'>\
                            <div class='modal-content'>\
                              ...
                              <div class='modal-footer'>\
                                    ...
                                    <a href='#' onclick='eliminar_conf_usuarios_imagen_nombre("+id_usuario+")'>\
