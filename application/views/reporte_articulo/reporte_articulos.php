...
if($matriz_articulos != false){
    $registros_totales = count($matriz_articulos);
}
...
if($matriz_articulos != false){
    for($i = 0; $i < count($matriz_articulos); $i++){
            ...
            $pdf->Cell(60, 4, $pdf->ajuste_texto($nombre_tipo_articulo), 1, 0, 'L', true);
            ...
            $pdf->Cell(60, 4, $pdf->ajuste_texto($fecha), 1, 1, 'C', true);
            ...
            // $pdf->SetAligns(array('L','L','R','L','C'));
            // $pdf->Row(array(
            //         //$id
            //         $pdf->ajuste_texto($nombre_tipo_articulo)
            //     ,   $pdf->ajuste_texto($nombre_articulo)
            //     ,   $pdf->ajuste_texto(number_format($disponible,2,",","."))
            //     ,   $pdf->ajuste_texto($fecha)
            // ));
            $pdf->Ln(0);
    }
}
