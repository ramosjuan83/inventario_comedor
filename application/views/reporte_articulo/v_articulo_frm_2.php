                ...
                <!--<div class="row">-->
                    <div class="card-header bg_color_2">
                        <h4>
                            ...
                            switch ($oper){
                                case 'reporte_form': ?>
                                        <span class="text-white">Reporte de Artículos</span><?php
                    ...
                    <div class="card-body bg-white">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 text-left">
                                    ...
                                    <select class="form-control bg_color_3 text-white" id="id_tipo_articulo" name="id_tipo_articulo"><?php
                                        $valorSel  = "";
                                        ?><option value="null">Seleccione</option><?php
                                ...
                                <script type="text/javascript"> 	                                        
                                    ...
                                    function ver_reporte(formato){
                                        if(valida() == true){
                                            ...
                                            let id_tipo_articulo      = document.form_principal.id_tipo_articulo.value;
                                            ...
                                            if(formato == 'pdf'){
                                                console.log("id_tipo_articulo",id_tipo_articulo);
                                                window.open("<?php echo ''.base_url('').''?>index.php/Inv_articulo/llama_reporte_form/"+id_articulo+"/"+id_almacen+"/"+$b_fecha_desde+"/"+$b_fecha_hasta+"/"+id_tipo_articulo+"/pdf");
                                            }
                                            if(formato == 'excel'){
                                                window.open("<?php echo ''.base_url('').''?>index.php/Inv_articulo/llama_reporte_form/"+id_articulo+"/"+id_almacen+"/"+$b_fecha_desde+"/"+$b_fecha_hasta+"/"+id_tipo_articulo+"/excel");
