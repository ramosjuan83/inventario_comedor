    ...
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    <i class="color_7 fas fa-warehouse fa-2x"></i>
                    <span class="color_7">Almacén</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <div class="col-md-6 float-left text-right container-fluid mt-2">
                ...
                if( strlen($this->session->userdata('inv_almacen_mensaje_tipo')) > 0  ){ ?>
                        <div class="alert <?php echo $this->session->userdata('inv_almacen_mensaje_tipo'); ?> text-center"><?php
                            echo $this->session->userdata('inv_almacen_mensaje_contenido'); ?>
                        </div><?php
                        $s_mensaje = array(
                                'inv_almacen_mensaje_tipo'         => '',
                                'inv_almacen_mensaje_contenido'    => ''
                        );
                        $this->session->set_userdata($s_mensaje);
                } ?>
            </div>
            <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Inv_almacen/agregar'); ?>" class="btn btn-primary">
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <?php if ($dat->id_status !=2) { ?>
                                            <a class="text_azul mr-2" href="<?=site_url('Inv_almacen/editar/'.$dat->id)?>">
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Inv_almacen/eliminar/'.$dat->id); ?>">
