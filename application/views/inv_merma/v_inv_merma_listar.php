    ...
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    <i class="color_7 fas fa-arrows-down-to-line fa-2x"></i>
                    <span class="color_7">Merma</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <!-- <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Inv_merma/agregar'); ?>" class="btn btn-primary">
            ...
            <form class="form-inline" action="listar" name="form_busqueda" id="form_busqueda" target="_self" enctype="multipart/form-data" method="POST">
                ...
                <script type="text/javascript">
                    function ver_reporte(formato){
                        ...
                        if(formato == 'pdf'){
                            window.open("<?php echo ''.base_url('').''?>index.php/Inv_merma/ver_pdf_lista/"+$b_texto);
                        }
                        if(formato == 'excel'){
                            window.open("<?php echo ''.base_url('').''?>index.php/Inv_merma/ver_excel_lista/"+$b_texto);    
                        }                            
                    }
                            ...
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    ...
                                    <?php if ($dat->id_status !=2) { ?>
                                        <a class="text_azul mr-2" href="<?=site_url('Inv_merma/editar/'.$dat->id)?>">
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Inv_merma/eliminar/'.$dat->id); ?>">
