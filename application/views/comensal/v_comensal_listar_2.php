<div class="container-fluid">
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-5 float-left estilo1">
                <h4>
                    <i class="text_sigalsx4_purpple_dark fas fa-calendar-day fa-2x"></i>
                    <span class="text_sigalsx4_purpple_dark">Programación de Comensales</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            //alert-success
            ?>
            <div class="col-md-5 float-left text-right container-fluid mt-2">
                <?php
            ...
            <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('comensal/agregar_2'); ?>" class="btn btn-primary">
    ...
    <div class="row">
        <div class="container-fluid mt-1">
            ...
            <form class="form-inline" action="listar_programados" name="form_busqueda" id="form_busqueda" target="_self" enctype="multipart/form-data" method="POST">
                    ...
                    if($dat_list != false){
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    ...
                                    <td class="text-left"><?=$dat->comensales_programacion_fecha." ".$dat->comensales_programacion_hora?></td>
                                    <td class="text-left"><?=$dat->comedor_comida_tipo_nombre?></td>
                                    
                                    <td class="text-left"><?php
                                        if($dat->comensales_programacion_estatus_2 == 1){ ?>
                                            <span class="text-warning mr-2" data-toggle="tooltip" data-placement="left" title="POR AGREGAR"><i class="fas fa-circle"></i></span><?php
                                        }
                                        if($dat->comensales_programacion_estatus_2 == 2){  ?>
                                            <span class="text-success mr-2" data-toggle="tooltip" data-placement="left" title="AGREGADO"><i class="fas fa-circle"></i></span><?php
                                        }                                    
                                        ?>
                                    </td>
                                    <td>
                                            ...
                                            if($dat->comensales_programacion_estatus_2 == 1){ ?>
                                                <a class="text-danger mr-2" href="#" data-toggle="modal" data-target="#exampleModal<?php echo $dat->comensales_programacion_id; ?>">
                                                    <span data-toggle="tooltip" data-placement="left" title="Eliminar"><i class="fas fa-trash-alt"></i></span>
                                                </a><?php                                                
                                            }else{ ?>
                                                <span class="text-secondary mr-2" data-toggle="tooltip" data-placement="left" title="Eliminar (No puede eliminar, ya se ha ejecutado de forma automática este registro)"><i class="fas fa-trash-alt"></i></span><?php
                                            } ?>

                                            <div class="modal fade" id="exampleModal<?php echo $dat->comensales_programacion_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-footer">
                                                    ...
                                                    <a href="<?php echo site_url('Comensal/eliminar_programados/'.$dat->comensales_programacion_id); ?>">
                                            ...
                                            if($dat->comensales_programacion_estatus == 1){ ?>
                                                <a class="text-danger mr-2" href="#" data-toggle="modal" data-target="#exampleModal<?php echo $dat->comensales_programacion_id; ?>">
		                                ...
		                                <div class="modal fade" id="exampleModal<?php echo $dat->comensales_programacion_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		                                  <div class="modal-dialog" role="document">
		                                    <div class="modal-content">
		                                      ...
		                                      <div class="modal-footer">
		                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
		                                        <a href="<?=site_url('Comensal/anular/'.$dat->comensales_programacion_id)?>">
		                                            <button type="button" class="btn btn-primary">Aceptar</button>
		                                        </a>
		                                      </div>
		                                    </div>
