                ...
                <!--<div class="row">-->
                    <div class="card-header bg_color_2">
                        <h4>
                            ...
                            switch ($oper){
                                case 'reporte_form': ?>
                                        <span class="text-white">Reporte comensal</span><?php
                    ...
                    <div class="card-body bg-white">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4 text-left">
                                    ...
                                    <input class="form-control" id="cedula" name="cedula" type="text" placeholder="C&eacute;dula" value="" size="10" maxlength="10">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 text-left">
                                    <label>IVIC / EXTERNO</label>
                                    <select class="form-control bg-sigalsx4-purpple_dark text-white selectpicker" id="tipo_personal" name="tipo_personal" data-show-subtext="true" data-live-search="true" onchange="habilita_tipo_de_personal()">
                                        <?php
                                        $valorSel  = "";
                                        $valor = "";  ?>
                                        ...
                                        $valor              = 2;
                                        $valor_a_mostrar    = "PERSONAL EXTERNO";
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 text-left">
                                    ...
                                    <select class="form-control bg_color_3 text-white" id="id_comedor_comida_tipo" name="id_comedor_comida_tipo"><?php
                                        $valorSel  = "";
                                ...
                                <script type="text/javascript"> 	                                        
                                    ...
                                    function ver_reporte(formato){
                                        if(valida() == true){
                                            ...
                                            if(formato == 'pdf'){
                                                window.open("<?php echo ''.base_url('').''?>index.php/Comensal/llama_reporte_form/"+$b_fecha_desde+"/"+$b_fecha_hasta+"/"+$cedula+"/"+$tipo_personal+"/"+$id_comedor_comida_tipo+"/"+$id_personal_visitante_tipo+"/"+$estados_id+"/pdf");
                                            }
                                            if(formato == 'excel'){
                                                window.open("<?php echo ''.base_url('').''?>index.php/Comensal/llama_reporte_form/"+$b_fecha_desde+"/"+$b_fecha_hasta+"/"+$cedula+"/"+$tipo_personal+"/"+$id_comedor_comida_tipo+"/"+$id_personal_visitante_tipo+"/"+$estados_id+"/excel");
                                            }                                        
