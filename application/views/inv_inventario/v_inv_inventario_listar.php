        ...
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    ...
                    <span class="color_7">Inventario</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <form class="form-inline" action="listar" name="form_busqueda" id="form_busqueda" target="_self" enctype="multipart/form-data" method="POST">
                ...
                <script type="text/javascript">
                    function ver_reporte(formato){
                        ...
                        if(formato == 'pdf'){
                            window.open("<?php echo ''.base_url('').''?>index.php/Inv_inventario/ver_pdf_lista/"+$b_texto);
                        }
                        if(formato == 'excel'){
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Inv_inventario/eliminar/'.$dat->id); ?>">
