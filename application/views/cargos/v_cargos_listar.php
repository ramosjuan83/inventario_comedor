    ...
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    <i class="color_7 fas fa-user-tie fa-2x"></i>
                    <span class="color_7">Cargos</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Cargos/agregar'); ?>" class="btn btn-primary">
                            ...
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a class="text_azul mr-2" href="<?=site_url('Cargos/editar/'.$dat->id)?>">
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Cargos/eliminar/'.$dat->id); ?>">
