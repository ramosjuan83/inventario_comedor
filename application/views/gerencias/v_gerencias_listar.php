    ...
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    <i class="color_7 fas fa-sitemap fa-2x"></i>
                    <span class="color_7">Centro</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <div class="col-md-6 float-left text-right container-fluid mt-2">
                ...
                if( strlen($this->session->userdata('gerencias_mensaje_tipo')) > 0  ){ ?>
                        <div class="alert <?php echo $this->session->userdata('gerencias_mensaje_tipo'); ?> text-center"><?php
                            echo $this->session->userdata('gerencias_mensaje_contenido'); ?>
                        </div><?php
                        $s_mensaje = array(
                                'gerencias_mensaje_tipo'         => '',
                                'gerencias_mensaje_contenido'    => ''
                        );
                        $this->session->set_userdata($s_mensaje);
                } ?>
            </div>
            <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Gerencias/agregar'); ?>" class="btn btn-primary">
                ...
                <table class="table table-hover bg-white" style="box-shadow: 1px 5px 5px 1px #d9d9d9">
                    ...
                    if($dat_list != false){
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    <th scope="row"><?=$dat->gerencias_id?></th>
                                    <td class="text-left"><?=$dat->gerencias_nombre?></td>
                                    <td class="text-left"><?=$dat->gerencias_2_nombre?></td>
                                    <td>
                                        
                                        <a class="text_azul mr-2" href="<?=site_url('Gerencias/editar/'.$dat->gerencias_id)?>">
                                        ...
                                        if($dat->esta_asociado_en_personal_ivic == true){ ?>
                                            ...
                                            <a class="text-danger mr-2" href="#" data-toggle="modal" data-target="#exampleModal<?php echo $dat->gerencias_id; ?>">
                                                <span data-toggle="tooltip" data-placement="left" title="Eliminar"><i class="fas fa-trash-alt"></i></span>
                                            </a><?php
                                        } ?>
                                            
                                        <div class="modal fade" id="exampleModal<?php echo $dat->gerencias_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Gerencias/eliminar/'.$dat->gerencias_id); ?>">
