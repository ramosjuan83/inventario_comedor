<div class="container-fluid">
        ...
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    ...
                    <span class="color_7">Personal Externo</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            //alert-success
            ?>
            <div class="col-md-4 float-left text-right container-fluid mt-2">
                <?php

                if( strlen($this->session->userdata('personal_visitante_mensaje_tipo')) > 0  ){ ?>
                        <div class="alert <?php echo $this->session->userdata('personal_visitante_mensaje_tipo'); ?> text-center"><?php
                            echo $this->session->userdata('personal_visitante_mensaje_contenido'); ?>
                        </div><?php
                        $s_mensaje = array(
                                'personal_visitante_mensaje_tipo'         => '',
                                'personal_visitante_mensaje_contenido'    => ''
                        );
            ...
            <div class="col-md-4 float-left text-right estilo1 container-fluid mt-2">
                <script type="text/javascript">
                    function ver_reporte(formato){
                        ...
                        if(formato == 'pdf'){
                            window.open("<?php echo ''.base_url('').''?>index.php/Personal_visitante/ver_pdf_lista/"+$b_texto+"/"+$b_estado);
                        }
                        if(formato == 'excel'){
                            window.open("<?php echo ''.base_url('').''?>index.php/Personal_visitante/ver_excel_lista/"+$b_texto+"/"+$b_estado);    
                        }                            
                    }
                ...
                <a href="<?php echo site_url('personal_visitante/agregar'); ?>" class="btn btn-outline-primary">
    ...
    <div class="row">
        <div class="container-fluid mt-1">
            ...
            <!--form action="personal_visitante/listar" method="post" name="form_busqueda" target="_self"-->
            <?php /*
            $atributos2 = array('name' => 'form_busqueda', 'id' => 'form_busqueda', 'enctype' => 'multipart/form-data');
            echo form_open('personal_visitante/listar', $atributos2); ?>
                            ...
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    ...
                                    <td class="text-center"><?php 
                                        ...
                                        if($dat->estado == 2){  ?>
                                            <span class="text-danger mr-2" data-toggle="tooltip" data-placement="left" title="No Activo"><i class="fas fa-circle"></i></span><?php
                                        } ?>
                                    </td>                                    
                                    <td>
                                        
                                        <a class="text_azul mr-2" href="<?=site_url('personal_visitante/editar/'.$dat->id)?>">
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('personal_visitante/eliminar/'.$dat->id); ?>">
