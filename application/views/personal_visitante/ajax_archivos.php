<script type="text/javascript">
        ...
        function mostrarArchivos(){
            ...
            $.post(baseurl+"index.php/Personal_ivic/get_personal_ivic_buscar_2",
            {
                id: id
            },
            function(data){ //alert(data);
                var matriz_personal_ivic = JSON.parse(data);
                imagen_nombre = matriz_personal_ivic[0]['imagen_nombre']
                if(imagen_nombre == null){
                    $("#archivos_subidos").html("");
                }else{
                    $("#archivos_subidos").html("");
                    $ruta = '<?php echo base_url("images/personal_ivic/"); ?>'+imagen_nombre;
