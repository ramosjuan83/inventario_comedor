                        ...
                        <script languaje="javascript">
                            function subirArchivos(){
                                if(validar_control_file() == true){
                                        ...
                                        $("#archivo").upload(baseurl+"index.php/Personal_ivic/get_subir_archivo",
                                        {
                                            id: id
                                        },
                                        function(respuesta){
...
////mostrarArchivos();
                    ...
                    //if($menu_origen == 'editar_como_administrador'){ ?>
                        <a href="<?=site_url('Personal_ivic/editar/'.$id)?>" id="btn_float" class="button button-circle button-flat-primary bg-sigalsx4-purpple">
