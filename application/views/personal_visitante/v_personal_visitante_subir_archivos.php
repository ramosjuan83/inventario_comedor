                        ...
                        <script languaje="javascript">
                            function subirArchivos(){
                                if(validar_control_file() == true){
                                        ...
                                        $("#archivo").upload(baseurl+"index.php/Personal_visitante/get_subir_archivo",
                                        {
                                            id: id
                                        },
                                        function(respuesta){
...
////mostrarArchivos();
                        ...
                        <form action="<?php echo ''.base_url('').''?>index.php/Personal_visitante/<?php echo $oper_g; ?>" name="form_principal" id="form_principal" method="post" enctype="multipart/form-data" target="_parent">
                    ...
                    //if($menu_origen == 'editar_como_administrador'){ ?>
                        <a href="<?=site_url('Personal_visitante/editar/'.$id)?>" id="btn_float" class="button button-circle button-flat-primary bg_color_3">
