<div class="container-fluid">
        ...
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    ...
                    <span class="color_7">Coordinación / Unidad</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <div class="col-md-6 float-left text-right container-fluid mt-2">
                ...
                if( strlen($this->session->userdata('departamento_mensaje_tipo')) > 0  ){ ?>
                        <div class="alert <?php echo $this->session->userdata('departamento_mensaje_tipo'); ?> text-center"><?php
                            echo $this->session->userdata('departamento_mensaje_contenido'); ?>
                        </div><?php
                        $s_mensaje = array(
                                'departamento_mensaje_tipo'         => '',
                                'departamento_mensaje_contenido'    => ''
                        );
                        $this->session->set_userdata($s_mensaje);
                } ?>
            </div>
            <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Departamento/agregar'); ?>" class="btn btn-primary">
    ...
    <div class="row">
        <div class="container-fluid mt-1">
            ...
            <!--form action="departamento/listar" method="post" name="form_busqueda" target="_self"-->
            <?php /*
            $atributos2 = array('name' => 'form_busqueda', 'id' => 'form_busqueda', 'enctype' => 'multipart/form-data');
            echo form_open('departamento/listar', $atributos2); ?>
