                ...
                <!--<div class="row">-->
                    <div class="card-header bg_color_2">
                        <h4>
                            ...
                            switch ($oper){
                                case 'agregar': ?>
                                        <span class="text-white">Agregar Coordinación / Unidad</span><?php
                                        $oper_g = "agregar_guardar";
                                break;
                                case 'editar': ?>
                                        <span class="text-white">Editar Coordinación / Unidad</span><?php
                        ...
                        <script languaje="javascript">
                            function valida(f){
                                ...
                                if(document.getElementById("id_gerencia").value == 'null')
                                {
                                    ...
                                    $('#error_id_gerencia').css('display', 'block');
                                    ok = false;
                                }else{
                                    $("#id_gerencia").removeClass("border-danger");
                                    $('#error_id_gerencia').css('display', 'none');
                                }
...
*/
                            ...
                            function valida_nombre(oper){
                                ...
                                if(oper == "agregar"){
                                    $.post(baseurl+"index.php/Departamento/get_Departamento_buscar_6",
                                    {
                                                nombre: nombre
                                    },
                                ...
                                if(oper == "editar"){
                                    ...
                                    $.post(baseurl+"index.php/Departamento/get_Departamento_buscar_5",
                                    {
                                                nombre: nombre
                                            ,   id: id
                                    },
                        ...
                        ?>
                        <?php echo form_open('Departamento/'.$oper_g, $atributos2);
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="comedor_comida_tipo_id_2">Centro <span style="color:#F00;">*</span></label>
                                <select class="form-control selectpicker" id="id_gerencia" name="id_gerencia" data-show-subtext="true" data-live-search="true"><?php
                                    if(isset($fila_registro->id_gerencia)){ $valorSel  = $fila_registro->id_gerencia; }else{ $valorSel = ""; }
                                ...
                                <span id="error_id_gerencia" style="display: none" class="text-danger error-camp">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6  text-center mt-3"><?php  
                                ...
                                if($oper == 'editar'){
                                    ...
                                    <br /><br />
                                    <a href="<?=site_url('Departamento/subir_archivo/').$fila_registro->id; ?>">
                    ...
                    <a href="<?php echo site_url('Departamento/listar/cargo_ultima_pagina'); ?>" id="btn_float" class="button button-circle button-flat-primary bg_color_3">
