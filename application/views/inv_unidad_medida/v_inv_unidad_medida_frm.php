                ...
                <!--<div class="row">-->
                    <div class="card-header bg_color_2">
                        <h4>
                            ...
                            <i class="text-white fas fa-weight fa-2x"></i>
                            <?php
                            switch ($oper){
                                case 'agregar': ?>
                                        <span class="text-white">Agregar Unidad Medida</span><?php
                                        $oper_g = "agregar_guardar";
                                break;
                                case 'editar': ?>
                                        <span class="text-white">Editar Unidad Medida</span><?php
...
*/
                            ...
                            function valida_nombre(oper){
                                ...
                                if(oper == "agregar"){
                                    $.post(baseurl+"index.php/Inv_unidad_medida/get_inv_unidad_medida_buscar_6",
                                    {
                                                nombre: nombre
                                    },
                                ...
                                if(oper == "editar"){
                                    ...
                                    $.post(baseurl+"index.php/Inv_unidad_medida/get_inv_unidad_medida_buscar_5",
                                    {
                                                nombre: nombre
                                            ,   id: id
                                    },
                        ...
                        ?>
                        <?php echo form_open('Inv_unidad_medida/'.$oper_g, $atributos2);
                    ...
                    <a href="<?php echo site_url('Inv_unidad_medida/listar/cargo_ultima_pagina'); ?>" id="btn_float" class="button button-circle button-flat-primary bg_color_3">
