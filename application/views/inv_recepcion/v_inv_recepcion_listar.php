    ...
    <div class="row">
        <div class="container-fluid mt-0">
            ...
            <div class="col-md-4 float-left estilo1">
                <h4>
                    <i class="color_7 fas fa-arrow-left fa-2x"></i>
                    <span class="color_7">Recepción</span>
                </h4>
            </div>
            <?php
            //alert-danger
            ...
            <!-- <div class="col-md-2 float-left text-right estilo1 container-fluid mt-2">
                <a href="<?php echo site_url('Inv_recepcion/agregar'); ?>" class="btn btn-primary">
            ...
            <form class="form-inline" action="listar" name="form_busqueda" id="form_busqueda" target="_self" enctype="multipart/form-data" method="POST">
                ...
                <script type="text/javascript">
                    function ver_reporte(formato){
                        ...
                        if(formato == 'pdf'){
                            window.open("<?php echo ''.base_url('').''?>index.php/Inv_recepcion/ver_pdf_lista/"+$b_texto);
                        }
                        if(formato == 'excel'){
                            window.open("<?php echo ''.base_url('').''?>index.php/Inv_recepcion/ver_excel_lista/"+$b_texto);    
                        }                            
                    }
                ...
                <table class="table table-hover bg-white" style="box-shadow: 1px 5px 5px 1px #d9d9d9">
                    <thead class="bg_color_1 text-white">
                        <tr class="text-center">
                            ...
                            <th scope="col" class="text-left">Fecha Ingreso</th>
                            <th scope="col" class="text-left">Almacén</th>
                            <th scope="col" class="text-left">Cantidad</th>
                            <th scope="col" class="text-left">Fecha Vencimiento</th>
                    ...
                    if($dat_list != false){
                            foreach ($dat_list as $dat) {   ?>
                                <tr class="text-center">
                                    ...
                                    <td class="text-left"><?=$dat->fecha_ingreso_2?></td>
                                    <td class="text-left"><?=$dat->nombre_almacen?></td>
                                    <td class="text-left"><?=$dat->cantidad?></td>
                                    <td class="text-left"><?=$dat->fecha_vencimiento_2 ?></td>
                                    <td class="text-left"><?=$dat->observacion?></td>
                                    <td>
                                        
                                    <?php if ($dat->id_status !=2) { ?>
                                        <a class="text_azul mr-2" href="<?=site_url('Inv_recepcion/editar/'.$dat->id)?>">
                                          ...
                                          <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <a href="<?php echo site_url('Inv_recepcion/eliminar/'.$dat->id); ?>">
